...
本教材では、GISソフトウェアやWEBアプリケーションによるGISの基礎操作および、WEBサイトからのデータやソフトウェアのダウンロード等について、**第三者の著作物**を利用し解説している場合があります。  
...
|元画像|権利者/クレジット表記|URL|
|---|---|---|
|Cesium公式サイト| Analytical Graphics, Inc. (AGI) |http://cesiumjs.org/index.html |
