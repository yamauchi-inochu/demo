...
教材の普及や理解度の向上のために、第三者の著作物であるGISソフトウェア、WEBアプリケーション、WEBサイトなどのスクリーンショットを公正な利用(fair use)として権利者の許諾を得ず、使用（加工も含む）しています。以下では、本教材中における第三者の著作物に関する権利者/クレジット等をまとめています。
