...
教材の普及や理解度の向上のため本教材では、第三者の著作物であるGISソフトウェア、WEBアプリケーション、WEBサイトなどのスクリーンショットを公正な利用(fair use)として権利者に無断で使用（加工も含む）しています。以下には、教材の項目と元となった画像（スクリーンショット）の権利者/クレジット等をまとめています。
