...
|JOSM|JOSM, and all its integral parts, are released under the GNU General Public License v2 or later.| (c) 2014, Humanitarian OpenStreetMap Team|
|OSM Tasking Manager|http://tasks.hotosm.org ( https://github.com/hotosm/osm-tasking-manager2/blob/master/LICENSE.txt) |
